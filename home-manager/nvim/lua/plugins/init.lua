...
require("lazy").setup({
	...
	-- NOTE: The imp/Users/user/Workspace/journals/notebook/obsidian_nbort below automatically adds your own plugins, configuration, etc from `lua/custom/plugins/*.lua`
